...
def generate_remittance_message(account_id, account, report_date):
    ...
    - 두 번째 문장: 뉴스 하이라이트를 기반으로 내가 응원하는 선수의 활약을 강조하고, 적금액을 요약하세요. 내가 응원하는 선수 관련 내용이 없을 경우, 활약 대신 우리 팀의 성과를 강조하세요.
    - 세 번째 문장: 적금 목표와 경기 결과에 따른 요약과, 격려와 응원의 메세지를 작성하세요.
    ...
    승리와 함께 내년 직관 자금도 한 걸음 더 가까워졌어요!"
    ---
    "두산이 5:4로 롯데를 꺾으며 끝내기 홈런까지 터졌습니다!
    박건우의 활약이 없는 것은 아쉽지만, 팀 승리, 홈런으로 총 25,000원 적립 완료!
    승리와 함께 새 유니폼 입는 날도 머지않았네요."
    ---
    "LG가 5:8로 NC에게 아쉽게 패배했지만, 3방의 홈런쇼!
    오지환 홈런 포함 총 26,000원 적립 완료!
    패배했음에도 불구하고 시즌권과의 거리는 한 걸음 가까워집니다!"
    ---
    "삼성이 6:4로 키움을 제압했네요!
    이학주 2안타·도루로 맹활약해 적금액 32,500원 달성!
    활발한 타선만큼 스프링캠프를 향한 통장도 든든해집니다."
